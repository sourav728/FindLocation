...
import static srv.map.R.id.map;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient2 = new GoogleApiClient.Builder(MapsActivity.this)
...
//Log.e("tag" , "points" + points.size());
        ...
        if (startTrack) {
            ...
            m = mMap.addMarker(new MarkerOptions().draggable(true).title("I am here ").
                    position(previouslatLng).icon(BitmapDescriptorFactory.fromResource(R.mipmap.walk)));
